    ...
    return (
        <div>
            ...
            <div className='project-header'>
                ...
                <div>
                    <a href='https://github.com/cjames223/GenIIDex' target='_blank'><img className='img' src={geniidex} /></a>
                </div>
                <div className='repo-live-link'>
                    <div>
                        <a href='https://github.com/cjames223/GenIIDex' target='_blank'>Repo</a>
                    </div>
                    <div>
                        <a href='https://cjames223.github.io/GenIIDex' target='_blank'>Live</a>
                    </div>
                </div>
            </div>
            <Footer />
